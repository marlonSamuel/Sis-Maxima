namespace SCP_MAXIMA.Models
{
    ...
    public partial class Model : DbContext
    {
        ...
        public virtual DbSet<tbl_prestacion_empleado> tbl_prestacion_empleado { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbl_empleado>()
                .HasMany(e => e.tbl_prestacion_empleado)
                .WithRequired(e => e.tbl_empleado)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<tbl_prestacion>()
                .HasMany(e => e.tbl_prestacion_empleado)
                .WithRequired(e => e.tbl_prestacion)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<tbl_prestacion_empleado>()
                .Property(e => e.detalle)
                .IsUnicode(false);
